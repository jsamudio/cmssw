...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:reHLT_HLT_Alpaka.root'),
...
process.pfHBHEGPUComparisonTask_HLT = DQMEDAnalyzer("TopoAnalyzer",
                                                    AlpakaToken = cms.untracked.InputTag('hltParticleFlowPFClusterAlpaka'),
                                                    LegacyToken = cms.InputTag('hltParticleFlowClusterHBHE', 'initialClusters'),
