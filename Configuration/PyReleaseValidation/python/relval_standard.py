...
workflows[136.888501] = ['RunJetHT2018DpixelCPU',['RunJetHT2018D','HLTDR2_2018','RECODR2_2018reHLT_Patatrack_PixelOnlyCPU','HARVEST2018_pixelTrackingOnly']]

### run 2018D ECAL-only ###
workflows[136.885511] = ['',['RunHLTPhy2018D','HLTDR2_2018','RECODR2_2018reHLT_ECALOnlyCPU','HARVEST2018_ECALOnly']]
workflows[136.888511] = ['RunJetHT2018DecalCPU',['RunJetHT2018D','HLTDR2_2018','RECODR2_2018reHLT_ECALOnlyCPU','HARVEST2018_ECALOnly']]

### run 2018D HCAL-only ###
workflows[136.885521] = ['',['RunHLTPhy2018D','HLTDR2_2018','RECODR2_2018reHLT_HCALOnlyCPU','HARVEST2018_HCALOnly']]
workflows[136.888521] = ['RunJetHT2018DhcalCPU',['RunJetHT2018D','HLTDR2_2018','RECODR2_2018reHLT_HCALOnlyCPU','HARVEST2018_HCALOnly']]
...
workflows[140.003] = ['',['RunZeroBias2022A','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.004] = ['',['RunBTagMu2022A','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.005] = ['',['RunJetHT2022A','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.006] = ['',['RunDisplacedJet2022A','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.007] = ['',['RunMET2022A','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.008] = ['',['RunEGamma2022A','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.009] = ['',['RunTau2022A','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.010] = ['',['RunDoubleMuon2022A','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.011] = ['',['RunMuonEG2022A','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]

workflows[140.021] = ['',['RunMinimumBias2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.022] = ['',['RunSingleMuon2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.023] = ['',['RunZeroBias2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.024] = ['',['RunBTagMu2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.025] = ['',['RunJetHT2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.026] = ['',['RunDisplacedJet2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.027] = ['',['RunMET2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.028] = ['',['RunEGamma2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.029] = ['',['RunTau2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.030] = ['',['RunDoubleMuon2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.031] = ['',['RunMuonEG2022B','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]

workflows[140.042] = ['',['RunSingleMuon2022C','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.043] = ['',['RunZeroBias2022C','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.044] = ['',['RunBTagMu2022C','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.045] = ['',['RunJetHT2022C','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.046] = ['',['RunDisplacedJet2022C','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.047] = ['',['RunMET2022C','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.048] = ['',['RunEGamma2022C','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.049] = ['',['RunTau2022C','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.050] = ['',['RunDoubleMuon2022C','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.051] = ['',['RunMuonEG2022C','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]

workflows[140.062] = ['',['RunMuon2022D','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.063] = ['',['RunZeroBias2022D','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.064] = ['',['RunBTagMu2022D','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.065] = ['',['RunJetMET2022D','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.066] = ['',['RunDisplacedJet2022D','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.067] = ['',['RunEGamma2022D','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
workflows[140.068] = ['',['RunTau2022D','HLTDR3_2022','RECONANORUN3_reHLT','HARVESTRUN3']]
