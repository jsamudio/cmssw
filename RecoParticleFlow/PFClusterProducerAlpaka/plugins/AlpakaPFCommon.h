#ifndef RecoParticleFlow_PFClusterProducerAlpaka_plugins_CudaPFCommon_h
#define RecoParticleFlow_PFClusterProducerAlpaka_plugins_CudaPFCommon_h
...
namespace PFClustering {
  namespace common {
    ...
    struct PosCalcConfig {
      ...
      PosCalcConfig() : minAllowedNormalization(-1.0), logWeightDenominatorInv(-1.0), minFractionInCalc(-1.0){};
...
#endif  // RecoParticleFlow_PFClusterProducerAlpaka_plugins_CudaPFCommon_h
