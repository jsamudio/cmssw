...
namespace PFRecHit {
  namespace HCAL {
    ...
    __device__ constexpr uint32_t getSubdet(uint32_t detId) {
    ...
    __device__ constexpr uint32_t getDepth(uint32_t detId) {
    ...
    __device__ constexpr uint32_t getIetaAbs(uint32_t detId) {
