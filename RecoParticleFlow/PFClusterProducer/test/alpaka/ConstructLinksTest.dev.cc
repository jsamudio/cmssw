...
constexpr double nSigmaEta_ = 0.1234;
constexpr double nSigmaPhi_ = 0.5678;
...
using namespace ALPAKA_ACCELERATOR_NAMESPACE;
  ...
  std::vector<ClusterLink> link(const ::reco::PFClusterCollection& clusters, const std::vector<double>& etaRMS2, const std::vector<double>& phiRMS2) {
